...
facade.testMon = function () {
  console.log("Chekcing api ================");
  console.log(api);
  api.getUiaBalances('testaccount44', function (err, result) {
    facade.lastError = err;
    console.log('bb==========================s', { err: err, result: result });
    if (result) {
      console.log('Balance(s) Found', result);
    } else {
      console.log('No Balance Found', err);
    }
  });
  // return "Love!"
};
