...
var _require = require("../../../assets-config/mainnet"),
    MAINNET_ASSETS = _require.MAINNET_ASSETS;
...
Types.asset = {
    ...
    appendByteBuffer: function appendByteBuffer(b, object) {
        ...
        var symbol = object.asset_id;

        var precision = MAINNET_ASSETS[symbol].precision;
        var amount = (object.amount / Math.pow(10, precision)).toString();

        //b.writeUint8(precision);
        if (/^[0-9]+\.[0-9]+\.[0-9]+$/.test(symbol)) {
            var valInt = object.amount;
